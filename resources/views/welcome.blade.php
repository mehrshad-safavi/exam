        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-4">
                    <div class="iq-card animation-card">
                        <div class="iq-card-body p-0">
                            ...
                            <div class="an-img">
                                <div class="bodymovin" data-bm-path={{ asset('assets/images/small/data.json') }}
            ...
            <div class="row">
                        ...
                        <div class="iq-card-body">
                                ...
                                <div class="col-sm-8">
                                    <div class="media-sellers">
                                        <div class="media-sellers-img">
                                            <img src={{ asset('assets/images/page-img/01.jpg') }} class="mr-3 rounded"
                                                alt="">
                                        </div>
                                        <div class="media-sellers-media-info">
                                            <h5 class="mb-0"><a class="text-dark" href="#">Android Tablet</a>
                                            </h5>
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-8">
                                    <div class="media-sellers">
                                        <div class="media-sellers-img">
                                            <img src={{ asset('assets/images/page-img/02.jpg') }} class="mr-3 rounded"
                                                alt="">
                                        </div>
                                        <div class="media-sellers-media-info">
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-8">
                                    <div class="media-sellers">
                                        <div class="media-sellers-img">
                                            <img src={{ asset('assets/images/page-img/03.jpg') }} class="mr-3 rounded"
                                                alt="">
                                        </div>
                                        <div class="media-sellers-media-info">
                                            <h5 class="mb-0"><a class="text-dark" href="#">I-Phone & I-Mac</a>
                                            </h5>
                            ...
                            <div class="iq-card">
                                ...
                                <div class="iq-card-body">
                                    <div class="media-support">
                                        <div class="media-support-header mb-2">
                                            <div class="media-support-user-img mr-3">
                                                <img class="rounded-circle" src={{ asset('assets/images/user/1.jpg') }}
                                                    alt="">
                                            </div>
                                    ...
                                    <div class="media-support">
                                        <div class="media-support-header mb-2">
                                            <div class="media-support-user-img mr-3">
                                                <img class="rounded-circle" src={{ asset('assets/images/user/02.jpg') }}
                                                    alt="">
                                            </div>
                                            <div class="media-support-info mt-2">
                                    ...
                                    <div class="media-support">
                                        <div class="media-support-header mb-2">
                                            <div class="media-support-user-img mr-3">
                                                <img class="rounded-circle" src={{ asset('assets/images/user/03.jpg') }}
                                                    alt="">
                                            </div>
                                            <div class="media-support-info mt-2">
                                    ...
                                    <div class="media-support">
                                        <div class="media-support-header mb-2">
                                            <div class="media-support-user-img mr-3">
                                                <img class="rounded-circle" src={{ asset('assets/images/user/04.jpg') }}
                                                    alt="">
                                            </div>
                                            <div class="media-support-info mt-2">
                ...
                <div class="col-lg-4">
                                ...
                                <li>
                                    ...
                                    <div class="d-inline-block w-100">
                                        ...
                                        <div class="iq-media-group">
                                            ...
                                            <a href="#" class="iq-media">
                                                <img class="img-fluid avatar-40 rounded-circle"
                                                    src="{{ asset('assets/images/user/06.jpg') }}" alt="">
                                            </a>
                                            <a href="#" class="iq-media">
                                                <img class="img-fluid avatar-40 rounded-circle"
                                                    src="{{ asset('assets/images/user/07.jpg') }}" alt="">
                                            </a>
                                            <a href="#" class="iq-media">
                                                <img class="img-fluid avatar-40 rounded-circle"
                                                    src="{{ asset('assets/images/user/08.jpg') }}" alt="">
                                            </a>
                                            <a href="#" class="iq-media">
                                                <img class="img-fluid avatar-40 rounded-circle"
                                                    src="{{ asset('assets/images/user/09.jpg') }}" alt="">
                                            </a>
                                            <a href="#" class="iq-media">
                                                <img class="img-fluid avatar-40 rounded-circle"
                    ...
                    <div class="iq-card">
                        <img src="{{ asset('assets/images/small/img-1.jpg') }}" class="img-fluid w-100 rounded"
                            alt="#">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
